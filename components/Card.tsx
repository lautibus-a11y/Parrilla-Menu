...
export const Card: React.FC<CardProps> = ({ item, onAdd }) => {
  ...
  return (
    <div className={`w-full max-w-[340px] bg-zinc-900/90 rounded-[3rem] p-5 transition-all duration-300 border border-white/5 group flex flex-col h-[520px] relative overflow-hidden ${isOut
      ? 'opacity-40 grayscale pointer-events-none'
      : 'active:scale-[0.98] active:border-orange-500/80 active:shadow-[0_0_30px_-5px_rgba(234,88,12,0.6)] hover:border-orange-500/80 hover:shadow-[0_0_30px_-5px_rgba(234,88,12,0.6)] hover:bg-zinc-800'
      }`}>
